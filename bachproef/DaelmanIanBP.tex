...
\newcommand{\good}{\textcolor{green!70!black}{\ding{51}}} % groen vinkje
\newcommand{\bad}{\textcolor{red}{\ding{55}}} % rood kruis
\newcommand{\na}{\textcolor{gray}{--}} % grijs streepje
...
\chapter{Bijlagen}
\input{chunks-verschillende-formaten}
\input{vragenlijst}
\input{antwoordenlijst}
\input{hallucinatie-resultaten}
\input{triviale-vragen-resultaten}
