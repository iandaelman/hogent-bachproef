...
De antwoorden die werden gegenereerd door de modellen zijn weergegeven in bijlage \ref{antwoordenlijst}.
...
Binnen de categorie Faithfulness duidt een score van 0,000 erop dat het model ten onrechte heeft nagelaten de retriever-tool te gebruiken, waardoor de opgehaalde context leeg bleef.
Voor de categorie Context Recall kan dit in bepaalde gevallen het tegenovergestelde effect hebben: wanneer de opgehaalde context leeg is, kan het antwoord van het model alsnog een score van 1 behalen indien het volledig aansluit bij de afwezigheid van context.
\\[1em]
