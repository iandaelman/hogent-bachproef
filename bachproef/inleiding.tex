...
\begin{itemize}
    \item Hoe kan een chatbot getraind worden op bestaande documentatie?
    ...
    \item Wat zijn bestaande meetstaven om de nauwkeurigheid van een LLM-model te meten en hoe presteren de verschillende implementaties?
    \item Welke implementatie heeft de voorkeur van de gebruiker en waarom?
\end{itemize}
